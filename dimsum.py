...
class BIO:
    ...
    def __init__(self, bio, label=None):
        ...
        self.numeric_label = int(str(1) + str(valid_labels[label]))
        if self.bio == 'B':
            self.numeric_label = int(str(2) + str(valid_labels[label])) 
        elif self.bio == 'I':
            self.numeric_label = int(str(3) + str(valid_labels[label])) 
    ...
    def __str__( self): return 'O' if self.bio == 'O' else (self.bio + '-' + self.label)
